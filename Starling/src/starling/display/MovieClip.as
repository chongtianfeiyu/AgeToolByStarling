...
package starling.display
{
    ...
    public class MovieClip extends Image implements IAnimatable
    {
		...
		private var mKeyFrame:int;
        
        /** Creates a movie clip from the provided textures and with the specified default framerate.
         *  The movie will have the size of the first frame. */  
        public function MovieClip(textures:Vector.<Texture>, fps:Number=12 ,keyFrame:int=0)
        {
			mKeyFrame = keyFrame;
        ...
        public function advanceTime(passedTime:Number):void
        {
            ...
            {				
                ...
                if(mKeyFrame==0)mKeyFrame = finalFrame;
			...
			{
				texture = mTextures[mCurrentFrame];
				if(mKeyFrame>0&&mKeyFrame==mCurrentFrame
				&&hasEventListener(Event.KEYFRAME))
					dispatchEventWith(Event.KEYFRAME);	//关键帧
			}
		...
		/**keyFrame */
		public function get keyFrame():int { return mKeyFrame; }
