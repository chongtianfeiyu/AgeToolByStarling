package starling.utils
{
    ...
    public class AssetManager
    {
        private const SUPPORTED_EXTENSIONS:Vector.<String> = 
            new <String>["png", "jpg", "jpeg", "atf", "mp3", "xml", "fnt", "info"]; 
		...
		private var _uniqueUrls:Array = [];
		
		public function enqueueUnique(assetsUrl:String):void{
			if(_uniqueUrls.indexOf(assetsUrl) == -1){
            ...
            function onUrlLoaderComplete(event:Event):void
            {
                ...
                switch (extension)
                {
                    ...
                    case "mp3":
                        ...
                        break;
					case "info":
						var bb:String = bytes.readUTFBytes(bytes.bytesAvailable)
						addLayou(name,JSON.parse(bb));
						onComplete();
						break;
                    default:
		...
		public function addLayou(name:String,obj:Object):void{
			objs[name] = obj;
		}
		
		public function removeLayou(name:String):void
		{
			delete objs[name];
		}
		
		public function getLayou(name:String):Object
		{
			return objs[name]
		}
