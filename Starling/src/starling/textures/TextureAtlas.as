	...
	public class TextureAtlas
	{
		...
		protected function parseAtlasXml(atlasXml:XML):void
		{
			...
			for each (var subTexture:XML in atlasXml.sprite)
			{
				...
				var width:Number=parseFloat(subTexture.attribute("w")) / scale;
				var height:Number=parseFloat(subTexture.attribute("h")) / scale;
				...
				var frameWidth:Number=parseFloat(subTexture.attribute("framew")) / scale;
				var frameHeight:Number=parseFloat(subTexture.attribute("frameh")) / scale;
