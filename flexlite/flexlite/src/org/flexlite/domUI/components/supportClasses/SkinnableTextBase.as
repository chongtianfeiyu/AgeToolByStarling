package org.flexlite.domUI.components.supportClasses
{
	...
	public class SkinnableTextBase extends SkinnableComponent
	{
		...
		override protected function getCurrentSkinState():String
		{
			...
			if (_prompt && skin is IStateClient && (!focus || !contains(focus)) && text == "")
			{
		...
		private function textDisplayAdded():void
		{
			...
			if (textDisplayProperties.selectionBeginIndex !== undefined)
			{
				textDisplay.setSelection(textDisplayProperties.selectionBeginIndex, textDisplayProperties.selectionEndIndex);
			}
